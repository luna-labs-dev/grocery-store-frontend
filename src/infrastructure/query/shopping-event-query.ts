import {
  ...
  type AddProductToCartSuccessResult,
  type EndShoppingEventParams,
  type EndShoppingEventResult,
  type FetchShoppingEventListParams,
  type GetShoppingEventByIdParams,
  type HttpError,
  type RemoveProductFromCartParams,
  type ShoppingEventListResponse,
  type StartShoppingEventParams,
  type StartShoppingEventResult,
